...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || DistancePreferenceFragment.class.getName().equals(fragmentName)
                || FavPreferenceFragment.class.getName().equals(fragmentName);
    }
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class FavPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference button = findPreference(getString(R.string.pref_key_delete_fav));
    ...
    public static class DistancePreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_distance);
            setHasOptionsMenu(true);
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("distance_value"));
        }
